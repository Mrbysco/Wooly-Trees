...
public class WoolyRegistry {
	...
	public static final DeferredBlock<WoolySaplingBlock> WOOLY_SAPLING = BLOCKS.registerBlock("wooly_sapling", (properties) -> new WoolySaplingBlock(WoolTree.WOOL, properties), () -> Block.Properties.ofFullCopy(Blocks.OAK_SAPLING).mapColor(MapColor.SNOW).noCollision().randomTicks().strength(0.0F).sound(SoundType.GRASS));
	public static final DeferredBlock<WoolySaplingBlock> JEB_SAPLING = BLOCKS.registerBlock("jeb_sapling", (properties) -> new WoolySaplingBlock(WoolTree.WOOL, properties),() ->  Block.Properties.ofFullCopy(Blocks.OAK_SAPLING).mapColor(MapColor.SNOW).noCollision().randomTicks().strength(0.0F).sound(SoundType.GRASS));
